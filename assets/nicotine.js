    ...
    if (sessionStorage.getItem("customerPrescriptionValid") == null) {
        ...
        //    alert(res);
            ...
            if (repeatsLeft > 0 && scriptExpiry > new Date()) {
                ...
                document.cookie = "customerPrescriptionValid=true; path=/; domain=myduke-staging.myshopify.com; Secure; SameSite=Lax"; // NEW CODE
            } else {
                sessionStorage.setItem("customerPrescriptionValid", "false");
                sessionStorage.setItem("customernicotineAmount", 0);
                document.cookie = "customerPrescriptionValid=; path=/; domain=myduke-staging.myshopify.com; max-age=0; Secure; SameSite=Lax"; // NEW CODE
            }
