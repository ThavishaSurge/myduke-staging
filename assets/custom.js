 ...
 icon_bg_mobile_slider();
  ...
  function getCookie(name) {
    ...
    if(utm_source != null){
        ...
        $('body a[href="https://staging.myduke.com.au/signup"]').attr('href','https://staging.myduke.com.au/signup?'+withutmparam);
        $('body a[href="https://staging.myduke.com.au/signup/"]').attr('href','https://staging.myduke.com.au/signup?'+withutmparam);
        ...
        $('body a[href="https://staging.myduke.com.au/signup"]').attr('href','https://staging.myduke.com.auu/signup?'+UTMQ);
        $('body a[href="https://staging.myduke.com.au/signup/"]').attr('href','https://staging.myduke.com.au/signup?'+UTMQ);
      }
     //}
});
